...
require_once __DIR__ . DIRECTORY_SEPARATOR . 'core' . DIRECTORY_SEPARATOR . 'include' . DIRECTORY_SEPARATOR . 'checksession.inc.php';
    ...
    switch ($_POST['service_type']) {
        case 'load_historical_quotes':
            ...
            if ($searchCriteriaController->isValidSearchCriteria()) {
                ...
                $highChartColumns->getDateSeriesForHighChart();
